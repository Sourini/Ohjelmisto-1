...
class Auto:
    def __init__(self, rt, hn, tn = 0, km = 0):
        self.rt = rt
        self.hn = hn
        self.tn = tn
        self.km = km
...
print(f'Auton rekisterinumero on {auto1.rt}, huippunopeus on {auto1.hn}km/h, tämänhetkinen nopeus on {auto1.tn}km/h, kuljettu matka on {auto1.km}km.')